...
class grid extends database
{
    ...
    function cargar($query, $campos = false, $result = false)
    {
        ...
        if (isset($this->features['dateformat']))
            $fformat = explode(',', $this->features['dateformat']["pos"]);
        ...
        if ($this->nreg == 0) {
            ...
            if (isset($this->features['borde'])) {
                ...
                echo '<table class="' . $this->features['borde']['style'] . '" width="100%" height="100%" cellpadding="0"  cellspacing="0"><tr><td align="center">';
            }
