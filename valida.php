...
if (isset($_POST['login1'])) {
    ...
    $DATOS = $i->simple_db("select e.id,concat(nombre,' ',apellido) as nombre,id_number,activo,email,sexo,
        (select lenguaje from tbl_setup) as lenguaje
		 from tbl_estudiante e where e.user = '$login' and e.pass = MD5('{$_POST['pass1']}')");
