...
if (isset($_POST['r4user'])) {
  ...
  if (!empty($_FILES['archivo']['name'])) {
    ...
    $prePath = '../../recursos/admin/fotos/';

    $sesubio = $crear->upload_file($_FILES['archivo'], $prePath . $_FILES['archivo']['name'], 1, 'image/gif,image/jpeg,image/png,image/pjpeg,image/jpg,image/pjpg');
    if ($sesubio == true) {

      @unlink($prePath . $_POST['image2']); ///borra la imagen subida original
      $prefi = @date("dhis_");
      $ruta = $prePath  . $_FILES['archivo']['name'];
      $ruta3 = $prePath  . $prefi . $_FILES['archivo']['name'];

      $imagen = new image($ruta);
      $imagen->redimensionar($ruta3, 75, 75, 100); ///redimension
      // retorna imagen para guardar en base de datos
      $prefImg = 'data:image/png;base64,';
      $img = file_get_contents($ruta3);
      $imgToSave = $prefImg . base64_encode($img);
      ...
      $_POST['r4img'] = $imgToSave; //guarda imagen en base de datos
    ...
    <tr>
      <td>
        ...
        <table style="border-right:#000000 solid 1px; border-left:#000000 solid 1px; border-bottom:#000000 solid 1px;" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              <form action="index.php" onSubmit="return validar();" method="post" enctype="multipart/form-data" name="form1">
                <table width="100%" border="0" cellspacing="4" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td width="391" colspan="3" rowspan="3" valign="top">
                        ...
                        <tr>
                          <td align="center">
                            <?php if (empty($data['foto'])) {
                              ...
                              $nombre = $data['foto'];
                            } ?><img style="border:solid 1px;image-rendering:optimizeQuality" src="<?= $data['img'] ?>"></td>
                        </tr>
                        <tr>
