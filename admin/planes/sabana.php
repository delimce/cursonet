            ...
            <tr bgcolor="<?php echo $colorf ?>">
              <td class="style1" style="cursor:pointer;text-transform: capitalize" title="ver detalles de <?php echo $est['nombre'] ?>" onClick="popup('../alumnos/detalles.php?id=<?php echo $est['id'] ?>','est','768','800');""><?php echo $est['nombre']; ?></td>
                ...
                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="52%" align="right" style="color:<?php echo $color ?>; font-weight:bold" class="small"><?php echo $nota;
                                                                                                                      unset($nota); ?></td>
                    <td width="48%" align="center" class="small"><?php echo $calc;
                                                                  unset($calc); ?></td>
                  </tr>
                </table>
              </td>
            ...
            <td align="center">
              <table width="70" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="right">
                    <span style="color:
								<?php $ttotal = ($ptotal * $planinfo['en_base']) / 100;
                if ($ttotal >= ($planinfo['en_base'] / 2)) {
                  $color = "#000066";
                  $APRO++;
                } else {
                  $color = "#990000";
                  echo $color;
                  $APLA++;
                } ?>; font-weight:bold" class="small">
                      <?php if ($planinfo['redondeo'] == 0) echo $ttotal;
                      else echo round($ttotal);
                      $tfinal += $ttotal;
                      unset($ttotal);  ?>
                    </span><span class="small"><?php echo $ptotal . '%';
                                                unset($ptotal); ?></span></td>
                </tr>
              </table>
            </td>
