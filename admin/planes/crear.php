...
<table width="100%" border="0" cellspacing="4" cellpadding="3">
  ...
  <td><?php echo $crear->combo_db("grupo","select id,nombre from tbl_grupo where curso_id = {$_SESSION['CURSOID']}","nombre","id",LANG_select,false,false,LANG_group_nogroup.'<input name="grupo" type="hidden" value="">'); ?></td>
</tr>
