...
<table width="800" height="550" border="0" align="center" cellpadding="0" cellspacing="0" valign="top">
  ...
  <tr>
   <td height="19" colspan="2" bgcolor="#F1F2EE">
			...
			<a href="http://www.dhtml-menu-builder.com"  style="display:none;visibility:hidden;">Javascript DHTML Drop Down Menu Powered by dhtml-menu-builder.com</a>
                ...
                stm_aix("p3i0","p2i0",[0,"Módulos","","",-1,-1,0,"contenidos/index.php","content","","Temas del curso"]);
                ...
                stm_ep();
                stm_aix("p0i7","p0i1",[]);
                stm_aix("p0i8","p0i0",[0,"Acompañamiento"]);
                stm_bpx("p6","p3",[]);
  ...
  <tr>
   <td colspan="3" valign="top" background="../images/backend/edunet_r6_c1.gif">
    ...
    <iframe align="middle" name="content" id="content" frameborder="0" scrolling="no" src="main.php" height="400" width="99%"  onload="DYNIFS.resize('content')"></iframe></td>
