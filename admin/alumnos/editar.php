...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
                        ...
                        <form name="form1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>"
                            ...
                            <table width="100%" border="0" cellspacing="4" cellpadding="3">
                                ...
                                <tr>
                                    ...
                                    <td><input name="email" type="text" id="email" value="<?= $data[5] ?>" size="25">
                                    </td>
                                    <td>&nbsp;</td>
                                    <td class="style3"><strong>
                                            <?= LANG_fecha_nac ?>
                                        </strong></td>
                                    <td><input name="fecha_nac" type="text" id="fecha_nac" onFocus="this.blur()"
                                               onClick="alert('<?= LANG_calendar_use ?>')" value="<?= $data[4] ?>"
                                               size="12">
                                        <img src="../../images/frontend/cal.gif" name="f_trigger_d" width="16"
                                             height="16" id="f_trigger_d" style="cursor: hand; border: 0px;"
                                             title="<?= LANG_calendar ?>">
                                        <script type="text/javascript">
                                            Calendar.setup({
      ...
      <input name="login12" type="text" id="login12" value="<?= $data[7] ?>">
                                    ...
                                    <td><input name="carrera" type="text" id="carrera" value="<?= $data[9] ?>"
                                               size="30"></td>
                                </tr>
                                <tr>
                                    <td class="style3"><strong><strong>
                                                ...
                                                <strong><strong><strong><strong>
                                                                <input name="boton" type="checkbox" class="small"
                                                                       onClick="cambio(this);" value="1">
      ...
      <input name="pass12" type="password" id="pass12" disabled="disabled">
                                    ...
                                    <td><input name="universidad" type="text" id="universidad" value="<?= $data[11] ?>"
                                               size="30"></td>
                                </tr>
                                <tr>
                                    <td class="style3"><strong>
                                    ...
                                    <td align="left"><textarea name="spreg" cols="30" rows="3" class="style1"
                                                               id="spreg"><?= $data[13] ?>
    </textarea></td>
                                </tr>
                                <tr>
      ...
      <?= LANG_is_active ?>
          ...
          <?= LANG_is_noactive ?>
                                    ...
                                    <td align="left"><input name="sresp" type="text" id="sresp" value="<?= $data[14] ?>"
                                                            size="30"></td>
                                </tr>
                                <tr>
                                    <td class="style3"><input name="orig" type="hidden" id="orig"
                                                              value="<?= $_REQUEST['orig'] ?>"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td class="style3">&nbsp;</td>
                                    <td>&nbsp;</td>
