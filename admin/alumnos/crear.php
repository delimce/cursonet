              ...
              <form name="form1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" onSubmit="return validar();">
                <table width="100%" border="0" cellspacing="4" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td width="29%"><input name="ci" type="text" id="ci" value="" maxlength="15"></td>
                    <td width="4%">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><input name="nivel" type="text" id="nivel" value=""></td>
                  </tr>
                  <tr>
                    ...
                    <td><input name="universidad" type="text" id="universidad" value="" size="30"></td>
                  </tr>
                  <tr>
                    <td class="style3"><strong>
                        <?= LANG_group ?>
                    ...
                    <td><textarea name="spreg" cols="30" rows="3" class="style1" id="spreg">
    </textarea></td>
                  </tr>
                  <tr>
                    <td class="style3"><strong>
                    ...
                    <td><input name="sresp" type="text" id="sresp" value="" size="30"></td>
                  </tr>
                  <tr>
