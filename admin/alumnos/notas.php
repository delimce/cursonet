                            ...
                            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="52%" align="right" style="color:<?php echo $color ?>; font-weight:bold" class="small"><?php echo $nota;
                                                                                                                                  unset($nota); ?></td>
                                <td width="48%" align="right" class="small"><?php echo $calc;
                                                                            unset($calc); ?></td>
                              </tr>
                            </table>
                          </td>
                          ...
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="52%" align="right"><span style="color:
                                <?php $ttotal = ($ptotal * $planinfo) / 100;
                              ...
                              <td width="48%" align="right"><span class="small"><?php echo $ptotal . '%'; ?></span></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
