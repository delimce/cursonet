...
if (isset($_REQUEST['alias'])) {
  ...
  $valores2[7] = ($_REQUEST['public']) ? 1 : 0;

  $crear->insertar2("tbl_curso", "nombre, alias, resp, fecha_creado, duracion, descripcion, notas, publico", $valores2);
  $crear->javaviso(LANG_cambios);

  ///////////si es el 1er caso
  $cuantos_cursos = $crear->simple_db("select count(*) from tbl_curso");
  if ($cuantos_cursos == 1) {
    $_SESSION['CURSOID'] = $crear->ultimoID;
  }
    ...
    <tr>
      <td>
        ...
        <table style="border-right:#000000 solid 1px; border-left:#000000 solid 1px; border-bottom:#000000 solid 1px;" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              <form name="form1" method="post" enctype="application/x-www-form-urlencoded" action="crearc.php" onSubmit="return validar();">
