...
$features = array(
    ...
    "orden" => array(3=>"date"),
    "abreviar" => array(1 => 65),
    "nuevo_vinculo1" => array("nombre" => "&nbsp;", "texto" => "<img border=\"0\" src=\"../../images/backend/button_edit.png\">", "url" => "editarc.php?", "target" => "_self", "parametro" => 0, "var_parametro" => 'ItemID', "title" => LANG_edit),
    ...
    "separacion" => array(0 => "1%", 1 => "65%", 2 => "22%", 3 => "15%"), //separacion de columnas
        ...
        <script language="JavaScript" type="text/javascript">
            function borrar(id, nombre) {
                ...
                if (confirm("<?= LANG_borrar ?> " + nombre + " ?")) {
                    ...
                    location.replace('borrarc.php?itemID=' + id);
            ...
            <tr>
                <td>
                    ...
                    <table style="border-right:#000000 solid 1px; border-left:#000000 solid 1px; border-bottom:#000000 solid 1px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><br>
                                <a href="crearc.php" class="style1"> <img src="../../images/backend/nuevo.gif" width="16" height="16" border="0" align="left"><?= LANG_add ?></a><br>
                                <br>
