...
if (isset($_REQUEST['ItemID'])) {
  ...
  $query = "select * from tbl_curso where id = '{$_REQUEST['ItemID']}'";
...
if (isset($_POST['alias'])) {
  ...
  $campos = explode(",", "nombre,alias,resp,duracion,descripcion,notas,publico");
    ...
    <tr>
      <td>
        ...
        <table style="border-right:#000000 solid 1px; border-left:#000000 solid 1px; border-bottom:#000000 solid 1px;" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              <form name="form1" method="post" action="editarc.php" onSubmit="return validar();">
                <table width="100%" border="0" cellspacing="4" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td width="80%">
                      <textarea class="style1" name="nombre" cols="45" rows="2" id="nombre"><?= $data['nombre'] ?> </textarea>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="checkbox" id="public" name="public" value="1" <?= ($data['publico']==1) ? 'checked' : '' ?>>
                    </td>
                  </tr>
