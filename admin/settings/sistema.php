...
<head>
    ...
    <script type="text/javascript">
        ...
        function showLocalTime(container, servermode, offsetMinutes, displayversion) {
            ...
            var servertimestring = (se r vermode == "s erver-php") ? '<?php print date("F d, Y H:i:s", time()) ?>' : (servermode = = "server-ssi") ? '<!--#config timefmt="%B %d, %Y %H:%M:%S"--><!--#echo var="DATE_LOCAL" -->' : '<%= Now() %>'
                        ...
                        <td>
                            <table width="99%" border="0" align="center" cellpadding="3" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="style1"><?php echo admin_usersonline(); ?> </td>
                                </tr>
                                <tr>
                                    <td valign="top" class="style3">
