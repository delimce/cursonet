      ...
      <tr>
        <td>
		  ...
		  <td width="73%" class="style1">
		    <? echo $_SERVER['SERVER_NAME']; echo ' '; echo  $_SERVER['SERVER_ADDR'];  ?>		  </td>
		  </tr>
		  <tr>
		  ...
		  <td class="style1">
			...
			if (mysql_ping($conn))  echo LANG_config_system_db_estatusc; else echo LANG_config_system_db_estatusn;
