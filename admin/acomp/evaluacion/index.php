...
$menu = new menu($menu_struct);
 ...
 $features = array (
	   ...
	   "formato"=> "html",
	   "oculto" => 0,
	   "orden" => array("nombre" => "orden1", "defecto" => "e.fecha desc","extras" => "&seccion={$_GET['seccion']}"),  
	   "abreviar" =>  array(1 => 40,3 => 35),  
   
	   "conenlace"  => array("pos" => 1, "title" => LANG_accomp_ppolitic, "url" => "prueba.php?","target" => "_self", "parametro" => 0, "var_parametro"=>"idpru"),  
  ...
  $query = "select distinct e.id, e.nombre as nombre, c.titulo as caso, date_format(e.fecha,'{$_SESSION['DB_FORMATO_DB']}') as fecha
  from tbl_evaluacion e,tbl_contenido c where e.contenido_id = c.id  $filtro";
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table style="border-right:#000000 solid 1px; border-left:#000000 solid 1px; border-bottom:#000000 solid 1px;" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>&nbsp;<?=LANG_group_filter ?> <form name="se" action="index.php" method="get"><?php echo  $combo->combo_db("seccion","select id,nombre from tbl_grupo order by nombre","nombre","id",LANG_all,false,"submit();");  ?></form><br>
