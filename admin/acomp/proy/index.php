...
$menu = new menu($menu_struct);
 ...
 $features = array (
	   ...
	   "formato"=> "html",
	   "oculto" => 0,
	   "orden" => array("nombre" => "orden1", "defecto" => "e.fecha_entrega desc","extras" => "&seccion={$_GET['seccion']}"),
	   "abreviar" =>  array(1 => 40,3 => 35),

	   "conenlace"  => array("pos" => 1, "title" => LANG_accomp_ppolitic, "url" => "proy.php?","target" => "_self", "parametro" => 0, "var_parametro"=>"idpro"),
