...
$menu = new menu($menu_struct);
	...
	if(isset($_GET['idpro'])){
		...
		$aco->query("select id from acomp where tipo = 'proy' and act_id = {$_POST['eva']} ");
			...
			///////////////////////////
			$aco->update("acomp",$campos2,$valores,"tipo = 'proy' and act_id = {$_POST['eva']}");
      ...
      <tr>
        <td><br>
          ...
          <table width="89%" border="0" align="center" cellpadding="2" cellspacing="1">
            ...
            <td width="48%" class="no_back"><?= $data[1] ?></td>
