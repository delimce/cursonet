...
$menu = new menu($menu_struct);
 ...
 $features = array (
	 ...
	 // "nuevo_vinculo2"  => array("nombre" => "&nbsp;", "texto" => "<img border=\"0\" src=\"../../images/backend/button_drop.png\">","url" => "#","target" => "_self", "parametro" => 0, "var_parametro" => 'ItemID', "title" => LANG_drop,"borrar"=>1),
       "separacion"   => array(0 => "1%", 1 => "45%", 2=> "25%",3=> "10%",4=> "10%",5 => "10%"), //separacion de columnas
  ...
  $grid->autoconexion();
  $query = "select c.id,titulo,ifnull((select concat(nombre,' ',apellido) from admin where id = c.autor),'".LANG_content_autor_unknow."') as autor,(select count(*) from contenido_recurso where contenido_id = c.id and tipo = 0 ) as archivos,
