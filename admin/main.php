...
?>
    ...
    <div style="background-image:url('../images/backend/main.jpg');
        ...
        <?php } else { ////no puede cargar la info del curso ?>
            ...
            <div class="notes" style="color: red"><?= LANG_enter_nocurse ?></div>
        ...
        $mensajes = $datos->simple_db("select count(*) from tbl_mensaje_admin where para = '{$_SESSION['USERID']}' and leido = 0");
        ...
        <?php if ($mensajes > 0) { ?>
            ...
            <div class="messages">
                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                        <td colspan="2"><a href="mensajes/index.php" class="style3"
                                           style="color:#0000FF"><?= LANG_msg_read ?></a></td>
                    </tr>
                </table>
            </div>
