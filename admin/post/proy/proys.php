...
$menu = new menu($menu_struct);
 ...
 $proys = $prueba->estructura_db("SELECT 
  a.id,
  LOWER(concat(e.nombre, ' ', e.apellido)) AS nombre,
  e.id_number,
  a.nota
FROM
		...
		<table
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
						<td width="50%" class="table_bk"><? echo LANG_proy_poreval; echo '  '.$totales[0]; ?></td>
						<td width="50%" class="table_bk"><? echo LANG_proy_eval2;  echo' '. $totales[1]; ?></td>
					</tr>


					<tr>
						<td class="style1" valign="top">
			 <?php if($totales[0]==0){ echo '<b>'.LANG_eva_nosin.'</b>'; }else{ ?> 
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
			  ...
			  ?>
                <tr>
					  ...
					  <td width="94%"><?
							echo "<a href=\"corregir.php?id={$proys[$i]['id']}\" title=\"".LANG_eva_corregir."\">".$proys[$i]['nombre']." ".$proys[$i]['id_number']."</a>"; ?></td>
					</tr>
			...
			?>
			  ...
			  <?php   }	  ?>
			   ...
			   <?php if($totales[1]==0){ echo '<b>'.LANG_eva_noeval.'</b>'; }else{ ?> 
			 <table width="100%" border="0" cellspacing="1" cellpadding="1">
			  ...
			  ?>
                <tr>
                   ...
                   <td width="6%" align="center" valign="top"><img src="../../../images/backend/button_drop.png" title="<?=LANG_drop.' '.$proys[$i]['nombre'] ?>" onClick="borrar('<?php echo $proys[$i]['id']; ?>','<?php echo $proys[$i]['nombre']; ?>');" style="cursor:pointer"></td>
				   <td width="94%"><? echo "<a href=\"corregir.php?id={$proys[$i]['id']}\" title=\"".LANG_eva_corregir."\">".$proys[$i]['nombre']." ".$proys[$i]['id_number']."</a>"; ?></td>
				</tr>
