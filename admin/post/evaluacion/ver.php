                        ...
                        <td colspan="4" align="left">
                            <table width="95%" border="0" align="center">
                                ...
                                for ($i = 0; $i < count($preguntas); $i++) {
                                    ...
                                    <tr>
                                        <td colspan="2"
                                            class="style3"><?php echo $np . '&nbsp;&nbsp;' . $preguntas[$i]['pregunta'] ?>
                                            &nbsp;<em style="color:blue"><?php echo $preguntas[$i]['nivel'] ?></em></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <ol type="a">
                                                ...
                                                for ($j = 0; $j < count($opciones); $j++) {
                                                    ...
                                                    if ($preguntas[$i]['preg_id'] == $opciones[$j]['preg_id']) {
                                                        ?>
                                                        <li style="padding: 8px; <?php if ($opciones[$j]['id'] == $preguntas[$i]['resp_opc']) echo 'color:blue;font-weight: bold'; ?> ">
                                                            <em><?php echo $opciones[$j]['opcion'] ?></em>
                                ...
                                <tr>
                                    <td colspan="2"><input type="button" name="Button" value="<?php echo LANG_back ?>"
