...
unset($_SESSION['EVAL_ID']);
 ...
 $features = array (
       ...
       "no_registers" => '<table bgcolor="#FFFFFF" width="100%"><tr><td align = "center"><b>'.LANG_eva_noexam2.'</b></td></tr></table>',
       "style_body" => "td_whbk",
       "style_head" => "table_bk",
       "r_header" => 20,
	   "formato"=> "html",
	   ...
	   "abreviar" =>  array(1=> 40,2 => 25,3 => 16),
	   "conenlace"  => array("pos" => 1, "title" => LANG_eva_following_ver, "url" => "info.php?","target" => "_self", "parametro" => 0, "var_parametro"=>"id"),  
