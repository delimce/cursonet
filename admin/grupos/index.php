...
$menu = new menu($menu_struct);
 ...
 $features = array (
  ...
  $grid->autoconexion();
  $query = "select id,nombre,descripcion,ifnull((select concat(nombre,' ',apellido) from admin where id = prof_id),'".LANG_content_autor_unknow."') as Resp, (select count(*) from grupo_estudiante where grupo_id = p.id and curso_id = {$_SESSION['CURSOID']}) as alumnos from grupo p where p.curso_id = {$_SESSION['CURSOID']}";
