                ...
                <td>
                    <form name="form1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                        <table width="100%" height="104" border="0" cellpadding="3" cellspacing="4" class="style1">
                            ...
                            <tr>
                            <tr>
                                <div class="style3" style="margin-left:26; margin-top: 11;"><input id="search_input"
                                                                                                   placeholder="<?= LANG_search ?>">&nbsp;<?= LANG_total ?>
                                    :&nbsp;<span id="num_results"></span></div>
                                <div class="style3" style="cursor: hand; margin-left:26;"
                                     onClick="javascript:CheckAll();"><?= LANG_select_all ?></div>
                                <ul id="search_list" style="list-style-type: none;">
                                    ...
                                    while ($row = $asig->db_vector_nom($asig->result)) {
                                        ...
                                        <li>
                                            <span width="6%" class="style1"><input name="select[]" type="checkbox"
                                                                                   id="select[]"
                                                                                   value="<?= $row['id'] ?>" <?php if ($_REQUEST['ItemID'] == $row['grupo']) echo 'checked="checked"'; ?>></span>
                                            <span width="34%" class="style1"
                                                  style="text-transform: capitalize"><?= $row['nombre']; ?></span>
                                            <span style="font-weight: bold" width="17%"
                                                  class="style1"><?= $row['id_number']; ?></span>
                                        </li>
                            ...
                            <tr>
                                <td colspan="4"><input type="button" name="Submit2" value="<?= LANG_back ?>"
                                                       onClick="javascript:history.back();">
                                    <?php if ($asig->nreg > 0) { ?> <input type="submit" name="Submit"
                                                                           value="<?= LANG_save ?>"><?php } ?>
