                        ...
                        <td>
                            <form name="form1" method="post" action="asignar.php">
                                <div style="padding: 8px; margin-top: 8px; display: inline-block; font-weight: bold">
                                    <label for="kwd_search"><?= LANG_search ?></label> <input type="text" id="kwd_search" value=""/>&nbsp;
                                    <input type="button" name="back2"  value="<?= LANG_back ?>" onClick="javascript:history.back();">&nbsp;
                                    <input type="submit" name="Submit3" value="<?= LANG_save ?>">&nbsp;
                                    <table id="recursos" width="100%" height="104" border="0" cellpadding="3" cellspacing="4" class="style1">
                                </div>
                                <thead>
                                    <tr>
