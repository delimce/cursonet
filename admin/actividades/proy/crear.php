...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="82%"><input name="nombre" type="text" id="nombre" value="" size="50"></td>
  </tr>
  <tr>
  ...
  <tr>
  <td colspan="2" align="center"><textarea name="enun" cols="96" rows="12" class="style1" id="enun"></textarea>  </td>
  </tr>
