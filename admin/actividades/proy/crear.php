                            ...
                            <form name="form1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" onSubmit="return validar();">
                                <table width="100%" border="0" cellspacing="4" cellpadding="3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style1" colspan="2"><?php echo $crear->combo_db("caso", "select id,IF(LENGTH(titulo)>60,concat(SUBSTRING(titulo,1,50),'...'),titulo) as titulo from tbl_contenido where curso_id = {$_SESSION['CURSOID']} and borrador = 0", "titulo", "id", LANG_select, false); ?></td>
                                    </tr>
                                    <tr>
                                        <td width="27%" valign="top" class="style1"><span class="style3"><?php echo LANG_seccion ?></span></td>
                                        <td class="style1"><select name="grupo" id="grupo">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style1">
                                            ...
                                            <input name="fecha" type="text" id="fecha" OnFocus="this.blur()" onClick="alert('<?= LANG_calendar_use ?>')" value="<?php echo date($_SESSION['DB_FORMATO']); ?>" size="12">
