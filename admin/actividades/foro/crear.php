...
if (isset($_POST['nombre'])) {
    ...
    $valores[5] = $fecha->fecha_db($_POST['inicio'], 1); ///inicio hora 00
                            ...
                            <td><form name="form1" method="post" action="crear.php" onSubmit="return validar();">
                                    ...
                                    <table width="100%" border="0" cellspacing="4" cellpadding="3">
                                        ...
                                        <tr>
                                            ...
                                            <td><? echo $crear->combo_db("caso", "select id,IF(LENGTH(titulo)>60,concat(SUBSTRING(titulo,1,50),'...'),titulo) as titulo from tbl_contenido where curso_id = {$_SESSION['CURSOID']}", "titulo", "id", LANG_select, false); ?></td>
                                        </tr>

                                        <tr>
                                            <td class="style3"><?php echo LANG_group_nombre; ?></td>
                                            <td><select name="seccion" id="seccion"><option value="0"><?=LANG_all?></option></select></td>
                                        </tr>


                                        <tr>
                                            <td class="style3"><?php echo LANG_team_name; ?></td>
                                            <td><select name="equipo" id="equipo"><option value="0"><?=LANG_all?></option></select></td>
                                        </tr>
