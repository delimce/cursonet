...
require_once("../../../../class/menu.php"); ////////clase
      $menu_struct = array (
	   "nombre" => "Evaluaciones de tipo desarrollo", /// mensaje si no se encuentran registros
       ...
       "items" =>  array( 0 => "mostrar",1 => "crear",2 => "Detalles"),
	   "url"  => array(0 => "index.php", 1 => "crear.php",2 => "detalles.php"),
