...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td colspan="2"><?php echo $crear->combo_db("caso","select id,titulo from tbl_contenido where curso_id = {$_SESSION['CURSOID']} and borrador = 0","titulo","id",LANG_select,$_SESSION['eva_caso'],"ajaxcombo('grupox','seccion','../../../grupos/gruposc.php?ide='+this.value,'seccion','nombre','valor');",'<input name="caso" type="hidden" value="">'.LANG_content_theme); ?></td>
 </tr>
   <tr>
  ...
  <tr>
    ...
    <td colspan="2"><input name="fecha" type="text" id="fecha" OnFocus="this.blur()" onClick="alert('<?=LANG_calendar_use?>')" value="<?php if($_SESSION['eva_fecha']=='') echo date($_SESSION['DB_FORMATO']); else echo $_SESSION['eva_fecha'];  ?>" size="12">
  ...
  <tr>
    ...
    <td colspan="2"><input name="fecha2" type="text" id="fecha2" OnFocus="this.blur()" onClick="alert('<?=LANG_calendar_use?>')" value="<?php if($_SESSION['eva_fecha']=='') echo date($_SESSION['DB_FORMATO']); else echo $_SESSION['eva_fecha2'];  ?>" size="12">
