...
<form name="form1" method="post" action="editap.php">
        ...
        <td>
          <table width="100%" border="0" cellspacing="4" cellpadding="3">
		   ...
		   ?>
            ...
            <tr>
              <td><textarea name="<?php if($datos[$i]['id']!=""){ echo $datos[$i]['id']; }else{ echo 'N'.$i;  } ?>" cols="92" rows="2" class="style1"><?=$datos[$i]['pregunta'] ?></textarea></td>
            </tr>
			...
			?>
			  ...
			  <tr>
              <td>
			    <input name="b1" type="button" id="b1" onClick="javascript:location.replace('editar.php');"  value="<?=LANG_back?>">
