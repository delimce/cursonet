...
$menu = new menu($menu_struct);
 ...
 $features = array (
       ...
       "conenlace" 		 =>  array("pos"=> 1,"title" => LANG_eva_ver_proof, "url" => "prueba.php?", "parametro" => 0, "var_parametro"=> "id"),
	   "separacion"   => array(0 => "1%", 1 => "25%", 2=> "30%",3=> "10%",4=> "12%",5=> "12%",6=> "18%"), //separacion de columnas
  ...
  from tbl_evaluacion e,tbl_contenido c where e.contenido_id = c.id and e.curso_id = {$_SESSION['CURSOID']} and tipo = 1";
