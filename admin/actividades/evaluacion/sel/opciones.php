...
<form id="opciones" name="opciones" method="post" action="">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1">
        ...
        <?php for ($i = 0; $i < $total; $i++) { ?>
            ...
            <tr>
                <td colspan="2" align="center"><input name="correcta" type="radio" id="correcta"
                                                      value="<?php echo $i ?>" <?php if ($i == $_SESSION['CORRECT']) echo 'checked'; ?>>
                </td>
                <td align="center"><input name="respuestas[]" type="text" class="small" id="respuestas[]"
                                          value="<?php echo $_SESSION['OPCIONES'][$i]; ?>" size="75"></td>
                <td align="center"><a href="#"
                                      onClick="document.opciones.borrar.value='<?php echo $i ?>'; document.opciones.submit();"><img
                                title="borrar opción" src="../../../../images/backend/cube_yellow_delete.png" width="16"
