...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td colspan="2"><?php echo $crear->combo_db("caso","select id,titulo from tbl_contenido where curso_id = {$_SESSION['CURSOID']} and borrador = 0","titulo","id",LANG_select,$datos['contenido_id'],false,'<input name="caso" type="hidden" value="">'.LANG_content_theme); ?></td>
 </tr>
   <tr>
    <td class="style3"><?php echo LANG_group_nombre; ?></td>
  <td colspan="2">
    <?php echo $crear->combo_db("grupo","select id, nombre from tbl_grupo where curso_id = {$_SESSION['CURSOID']}","nombre","id",LANG_all,$datos['grupo_id'],false,'<input name="grupo" type="hidden" value="">'); ?> </td>
</tr>
  <tr>
  <td class="style3">&nbsp;</td>
  <td colspan="2">
