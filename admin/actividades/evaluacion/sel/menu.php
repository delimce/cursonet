...
require_once("../../../../class/menu.php"); ////////clase
      $menu_struct = array (
	   "nombre" => "Evaluaciones de tipo Selección", /// mensaje si no se encuentran registros
       ...
       "items" =>  array( 0 => "Evaluaciones",1 => "Crear Nueva",2 => "Preguntas"),
	   "url"  => array(0 => "index.php", 1 => "crear.php",2 => "preg.php"),
