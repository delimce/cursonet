            ...
            <td width="528" height="63" valign="top" class="style1">
                <div style="margin-right:20;">
                    <p><b>
                        ...
                        <?php echo $_SESSION['CASO_AUTOR']; ?></div>
            </td>
                            ...
                            <td colspan="5" class="td_whbk2">
                                <table width="100%" border="0" cellspacing="1" cellpadding="2">
                                    ...
                                    while ($row = $datos->db_vector_nom($datos->result)) {
                                        ...
                                        ?>
                                        <tr>
                                            <td bgcolor="#FFFFFF" class="style1" style="text-indent:4px;"
                                                title="<?= $row['resumen'] ?>"><a
                                                    href="foro_coments.php?idf=<?= $row['id'] ?>"> <?= $row['titulo'] ?></a>
                                            </td>
                                            <td bgcolor="#FFFFFF" class="style1"
                                                align="center"><?= $row['fecha1'] ?></td>
                                            <td bgcolor="#FFFFFF" class="style1"
                                                align="center"><?= $row['fecha2'] ?></td>
                                            <td bgcolor="#FFFFFF" class="style1" align="center"><?= $row['nota'] ?></td>
                                            <td bgcolor="#FFFFFF" class="style1"
                                                align="center"><?= $row['comentarios'] ?></td>
                                        </tr>
