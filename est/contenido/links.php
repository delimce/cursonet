	...
	<td height="21" colspan="2" valign="top" class="content-est-tools">
	 <div id="index2">&nbsp;
	   <table width="100%" border="0" cellspacing="2" cellpadding="2">
         ...
         <tr>
           <td class="style3"><? if($datos->nreg==0) echo LANG_content_nolinks ?></td>
         </tr>
         ...
         <tr>
           <td><a class="style3" target="_blank" href="<? echo trim($row['dir']); ?>"><?=$row['dir'] ?></a><br> <span class="linkmenu"><?=$row['descripcion']?></span></td>
          </tr>
