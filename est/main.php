                ...
                $.ajax
                        ({
                            ...
                            cache: false,
                                    ...
                                    {
                                        $("#cnombre").html(data.titulo);
                                        $("#cfecha").html(data.fecha);
                                        var autor = '<a target="content" style="color:#03F; text-decoration:none" href="staff.php?id=' + data.autor + '">' + data.prof + '</a>';
                                        $("#cautor").html(autor);
                                        $("#cnreg").html(data.cant);
                                        $("#lecturas").html(data.leido);
                                        ////datos de retorno
                ...
                <td width="58%" align="center" style="border: #9AB1B6 1px solid;">
                    <table width="98%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="style1">
                                <?php
                                echo $datos->combo_db("casos", "select  id, IF(LENGTH(titulo)>60,concat(SUBSTRING(titulo,1,60),'...'),titulo) as titulo from tbl_contenido c where c.curso_id = '{$_SESSION['CURSOID']}'  and c.borrador = 0", "titulo", "id", LANG_select, $_SESSION['CASOACTUAL'], false, LANG_est_nogroup_cont);
                                ?>
                            </td>
                        </tr>
                        <tr height="10">
                        ...
                        <tr>
                            ...
                            <td><div class="small" id="cnreg">-</div></td>
                        </tr>
                        <tr>
                                ...
                                while ($row = $datos->db_vector_nom($datos->result)) {
                                    ...
                                    <table style="border-bottom:solid 1px; border-color:#999999;" onMouseOver="mm.stop();" onMouseOut="mm.start();" width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr class="style4">
                                            <td>
                                                <?php
                                                echo 'Mensaje publicado el ' . $row['fecha'];
                                                if ($row['destaca']) {
